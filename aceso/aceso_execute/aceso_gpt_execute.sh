...
####  config Paths ####
RESULT_PATH=${ROOT_PATH}logs/
LOG_PATH=${RESULT_PATH}${model_name}/${model_size}/
CONFIG_SAVE_PATH=${ROOT_PATH}../search_configs/configs/${model_name}/${model_size}/top_configs/
mkdir -p ${LOG_PATH}csv

VOCAB_FILE="${ROOT_PATH}../../vocab_file/gpt2-vocab.json"
MERGE_FILE="${ROOT_PATH}../../vocab_file/gpt2-merges.txt"
...
torchrun $DISTRIBUTED_ARGS ${ROOT_PATH}../../pretrain_gpt.py \
